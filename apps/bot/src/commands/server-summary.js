import { activeSessionsResponseSchema, knownPlayersResponseSchema, recentEventsResponseSchema } from '@gameops/shared';
...
function summarizeJoinLeave(events) {
...
function summarizeHealthWarnings(events) {
    return events
...
export const serverSummaryCommand = {
