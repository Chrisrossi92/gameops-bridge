...
import { registerPlayerActivityCaptureVerificationRoutes } from './routes/player-activity-capture-verification.js';
...
await registerCommunityActivityRoutes(app);
...
await registerPlayerActivityCaptureVerificationRoutes(app);
